...
export const ComponentCard = ({
  ...
  return (
    <>
      ...
      >
        ...
        {more ? (
          ...
          <div className="flex justify-end">
            <div
              className={`cursor-pointer flex justify-end gap-2 mr-6 ${
                bg ? "hover:text-red-500" : "hover:text-emerald-500"
              }`}
      ...
      {showModal && (
        <div
          className="fixed inset-0 z-50 bg-black/60 flex items-start justify-center pt-[5%]"
